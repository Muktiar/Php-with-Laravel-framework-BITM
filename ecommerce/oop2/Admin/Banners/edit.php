    ...
    <div class="container">
        <div  class="row justify-content-center">
            <div class="container">
                ...
                <form method="post" action="update.php?id=<?= $banners['id']?>"enctype="multipart/form-data">
                    <div class="mb-3 row">
                        <label for="title" class="col-sm-2 col-form-label">Title</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="title" name="title" value="<?= $banners['title'];?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="description" class="col-sm-2 col-form-label">Description</label>
                        <div class="col-sm-8">
                            <textarea type="text" class="form-control" id="description" name="description" ><?= $banners['description'];?></textarea>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="formFile" class="all-form-label">Picture</label>
                        <div class="col-sm-6">
                            <input type="file" class="form-control" id="formFile" name="picture" value=" <?= $banners['picture'];?>">
                            <img src="<?=$webroot;?>uploads/<?=$banners['picture'];?>">
                            <input type="hidden" name="old_picture" value="<?=$banners['picture'];?>">
