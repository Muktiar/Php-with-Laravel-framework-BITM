...
//date_default_timezone_set('ASIA/DHAKA');
        ...
        $query = "INSERT INTO `users` (`title`,`detail`, `picture`, `is_active`, `created_at`) VALUES (:title,:detail ,:picture, :is_active, :created_at)";
...
//Working with image
        ...
        $query = "UPDATE `users` SET `title` = :title, `picture` = :picture, `is_active` = :is_active, `modified_at` = :modified_at WHERE `users`.`id` = :id";
